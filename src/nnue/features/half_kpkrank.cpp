...
namespace Eval::NNUE::Features {
  ...
  inline IndexType HalfKPKrank<AssociatedKing>::MakeIndex(
    ...
    return IndexType(orient(perspective, s) + kpp_board_index[pc][perspective] + PS_END * ksq
           + static_cast<IndexType>(SQUARE_NB) * static_cast<IndexType>(PS_END) * static_cast<IndexType>(rank_of(other_ksq)));
  }
