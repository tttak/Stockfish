...
#ifndef NNUE_FEATURES_HALF_KPKFILE_H_INCLUDED
#define NNUE_FEATURES_HALF_KPKFILE_H_INCLUDED
...
namespace Eval::NNUE::Features {
  ...
  // Feature HalfKPKfile: Combination of the position of own king
  // and the position of pieces other than kings
  // and the file of the other king
  template <Side AssociatedKing>
  class HalfKPKfile {

   public:
    // Feature name
    static constexpr const char* kName = "HalfKPKfile(Friend)";
...
#endif // #ifndef NNUE_FEATURES_HALF_KPKFILE_H_INCLUDED
